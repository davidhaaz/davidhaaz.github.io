...
function updatePasswordRequirements(pw) {
  ...
  if (pw.length > 0) {
    reqLength.style.color = req1 ? '#6b6963' : '#c0442b';
    check1.style.display = req1 ? 'inline' : 'none';
  } else {
    reqLength.style.color = '#6b6963';
  ...
  if (pw.length > 0) {
    reqTypes.style.color = req2 ? '#6b6963' : '#c0442b';
    check2.style.display = req2 ? 'inline' : 'none';
  } else {
  ...
  if (pw.length > 0 && alias.length > 0) {
    reqEmail.style.color = req3 ? '#6b6963' : '#c0442b';
    check3.style.display = req3 ? 'inline' : 'none';
  } else {
    reqEmail.style.color = '#6b6963';
